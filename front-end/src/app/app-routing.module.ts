...
const routes: Routes = [
    ...
    { path: "game-gameResult", component: GameResultComponent, data: { title: "Résultat quiz" } },
    ...
    { path: 'question-form/:id', component: QuestionFormComponent, data: { title: "Formulaire de modification de question" } },
