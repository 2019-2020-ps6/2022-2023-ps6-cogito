...
test.describe('Theme feature', () => {
  test('Create theme sucessfully', async ({ page }) => {
    ...
    await test.step('Click on Ergotherapeute', async () => {
    ...
    await test.step('Click on addObject', async () => {
      await page.click('a#addObject');
    });

    await page.fill('input#nameTheme', 'test');
    ...
    await test.step('Click on Sauvegarder Theme', async () => {
      await page.click('button#saveElement');
    });
    ...
    await test.step('Click on Annuler Theme', async () => {
      await page.click('button#annulerElement');
    });
    ...
    await test.step('Click on supprObject', async () => {
      await page.click('a#supprObject');
    });
